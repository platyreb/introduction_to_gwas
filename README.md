...
- Lecture 0	General Introduction / Overview of the Course [Filippo, Oscar, Christian]
    - [General Introduction](slides/0.General Introduction _ Overview of the course .pdf)
...
- Lecture 11 GWAS Model Extensions and Applications: [Filippo, Christian, Oscar]
    - [11.1 GWAS Model Extensions_Dominance_and_other_genotype_Codifications](<slides/11.1 GWAS_model_extensions_genotype_codification.pdf>)
    - [11.2 GWAS Model Extensions_Polyploids](slides/11.2GWAS_model_extensions_polyploids.pdf)
        - [R code GWASpoly (vignette)]<!--(slides/GWASpoly_vignette.pdf)-->
    - [11.3 GWAS Model Extensions_Trait_Types: categorical, longitudinal](model_extensions/)
        - [slides](slides/11.3.GWAS_model_extensions_trait_type.pdf)
    ...
    - 11.4 GWAS Model Extensions Multi-Trait Multi-Locus models & software
        - [slides](slides/11.4.GWAS_model_extensions_multi_trait_and_locus.pdf)
        - [multiple-trait models](model_extensions/multi_trait)
        - [multiple-loci models](model_extensions/multi_locus)
    - [11.5 A bioinformatic pipeline for GWAS](7.pipeline/)
        - [slides](<slides/11.5.A bioinformatic pipeline for GWAS.pdf>)
    - 11.6 Additional software for GWAS
